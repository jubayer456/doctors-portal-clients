...
const Appointment = () => {
    return (
        <div style={{
            ...
            <div className="hero-content flex-col lg:flex-row  text-white my-20 p-12 ">
                <img src={img1} className="max-w-sm rounded-lg mt-[-100px] hidden lg:block  " alt='' />
                <div className='rounded border-sm'>
