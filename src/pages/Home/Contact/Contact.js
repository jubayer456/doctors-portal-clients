...
const Contact = () => {
    return (
        <div class=" py-8 my-8" style={{ background: `url(${img})` }}>
            <div class="text-center text-white ">
                <div class="max-w-md mx-auto">
                    <h3 class=" text-lg font-bold text-secondary">Contact Us</h3>
                    ...
                    <button class="btn btn-secondary uppercase text-white font-bold bg-gradient-to-r from-secondary to-primary">Submit</button>
                </div>
            </div>
        </div>
    );
